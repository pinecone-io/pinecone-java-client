...
public class VectorOperationsApi {
     ...
     */
    public okhttp3.Call updateVectorsCall(UpdateRequest updateRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateVectorsValidateBeforeCall(UpdateRequest updateRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'updateRequest' is set
        if (updateRequest == null) {
            throw new ApiException("Missing the required parameter 'updateRequest' when calling updateVectors(Async)");
        }

        return updateVectorsCall(updateRequest, _callback);
     ...
     */
    public Object updateVectors(UpdateRequest updateRequest) throws ApiException {
        ApiResponse<Object> localVarResp = updateVectorsWithHttpInfo(updateRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> updateVectorsWithHttpInfo(UpdateRequest updateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateVectorsValidateBeforeCall(updateRequest, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateVectorsAsync(UpdateRequest updateRequest, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateVectorsValidateBeforeCall(updateRequest, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

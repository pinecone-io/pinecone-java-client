...
public class StartImportRequest {
  ...
  public static final String SERIALIZED_NAME_ERROR_MODE = "errorMode";
  @SerializedName(SERIALIZED_NAME_ERROR_MODE)
  private ImportErrorMode errorMode;

  public StartImportRequest() {
  }

  public StartImportRequest integrationId(String integrationId) {
  ...
  **/
  ...
  public StartImportRequest uri(String uri) {
  ...
  **/
  ...
  public StartImportRequest errorMode(ImportErrorMode errorMode) {
  ...
  **/
  @javax.annotation.Nullable
  public ImportErrorMode getErrorMode() {
    return errorMode;
  }


  public void setErrorMode(ImportErrorMode errorMode) {
    this.errorMode = errorMode;
  }
   ...
   * @return the StartImportRequest instance itself
   */
  public StartImportRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.integrationId, startImportRequest.integrationId) &&
        Objects.equals(this.uri, startImportRequest.uri) &&
        Objects.equals(this.errorMode, startImportRequest.errorMode)&&
        Objects.equals(this.additionalProperties, startImportRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationId, uri, errorMode, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("errorMode") != null && !jsonObj.get("errorMode").isJsonNull()) {
        ImportErrorMode.validateJsonElement(jsonObj.get("errorMode"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StartImportRequest>() {
           ...
           public StartImportRequest read(JsonReader in) throws IOException {
             ...
             StartImportRequest instance = thisAdapter.fromJsonTree(jsonObj);

...
public class NamespaceDescription {
  ...
  public NamespaceDescription name(String name) {
  ...
  **/
  ...
  public NamespaceDescription recordCount(Long recordCount) {
  ...
  **/
  ...
  public NamespaceDescription schema(CreateNamespaceRequestSchema schema) {
  ...
  **/
   ...
   * @return the NamespaceDescription instance itself
   */
  public NamespaceDescription putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NamespaceDescription namespaceDescription = (NamespaceDescription) o;
  ...
  public String toString() {
    ...
    sb.append("class NamespaceDescription {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to NamespaceDescription
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NamespaceDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NamespaceDescription is not found in the empty JSON string", NamespaceDescription.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NamespaceDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NamespaceDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NamespaceDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NamespaceDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<NamespaceDescription>() {
           @Override
           public void write(JsonWriter out, NamespaceDescription value) throws IOException {
           ...
           @Override
           public NamespaceDescription read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             NamespaceDescription instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NamespaceDescription given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NamespaceDescription
  * @throws IOException if the JSON string is invalid with respect to NamespaceDescription
  */
  public static NamespaceDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NamespaceDescription.class);
  }

 /**
  * Convert an instance of NamespaceDescription to an JSON string
  *
  * @return JSON string
  */

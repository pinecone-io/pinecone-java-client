...
public class UpsertRequest {
  ...
  **/
   ...
   * @return the UpsertRequest instance itself
   */
  public UpsertRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.vectors, upsertRequest.vectors) &&
        ...
        Objects.equals(this.additionalProperties, upsertRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vectors, namespace, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayvectors.size(); i++) {
        Vector.validateJsonElement(jsonArrayvectors.get(i));
      };
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpsertRequest>() {
           ...
           public UpsertRequest read(JsonReader in) throws IOException {
             ...
             UpsertRequest instance = thisAdapter.fromJsonTree(jsonObj);

...
public class ListItem {
  ...
  **/
   ...
   * @return the ListItem instance itself
   */
  public ListItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, listItem.id)&&
        Objects.equals(this.additionalProperties, listItem.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListItem>() {
           ...
           public ListItem read(JsonReader in) throws IOException {
             ...
             ListItem instance = thisAdapter.fromJsonTree(jsonObj);

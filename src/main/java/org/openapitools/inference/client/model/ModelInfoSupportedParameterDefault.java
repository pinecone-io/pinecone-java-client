...
public class ModelInfoSupportedParameterDefault extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ModelInfoSupportedParameterDefault.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ModelInfoSupportedParameterDefault.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ModelInfoSupportedParameterDefault' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ModelInfoSupportedParameterDefault>() {
                @Override
                public void write(JsonWriter out, ModelInfoSupportedParameterDefault value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemae: Boolean, Float, Integer, String");
                }

                @Override
                public ModelInfoSupportedParameterDefault read(JsonReader in) throws IOException {
                    ...
                    try {
                      ...
                      ModelInfoSupportedParameterDefault ret = new ModelInfoSupportedParameterDefault();
                    ...
                    throw new IOException(String.format("Failed deserialization for ModelInfoSupportedParameterDefault: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ModelInfoSupportedParameterDefault() {
        super("anyOf", Boolean.FALSE);
    }

    public ModelInfoSupportedParameterDefault(Boolean o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ModelInfoSupportedParameterDefault(Float o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ModelInfoSupportedParameterDefault(Integer o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ModelInfoSupportedParameterDefault(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ModelInfoSupportedParameterDefault.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Boolean, Float, Integer, String");
    }
     ...
     * Boolean, Float, Integer, String
     *
     * @return The actual instance (Boolean, Float, Integer, String)
     */
    @Override
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelInfoSupportedParameterDefault
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    throw new IOException(String.format("The JSON string is invalid for ModelInfoSupportedParameterDefault with anyOf schemas: Boolean, Float, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    
  }

 /**
  * Create an instance of ModelInfoSupportedParameterDefault given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelInfoSupportedParameterDefault
  * @throws IOException if the JSON string is invalid with respect to ModelInfoSupportedParameterDefault
  */
  public static ModelInfoSupportedParameterDefault fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelInfoSupportedParameterDefault.class);
  }

 /**
  * Convert an instance of ModelInfoSupportedParameterDefault to an JSON string
  *
  * @return JSON string
  */

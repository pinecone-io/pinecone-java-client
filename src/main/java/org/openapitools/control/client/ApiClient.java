...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2024-07/java");
     ...
     * @return a {@link org.openapitools.control.client.ApiClient} object
     */
     ...
     * @throws org.openapitools.control.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws org.openapitools.control.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws org.openapitools.control.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws org.openapitools.control.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws org.openapitools.control.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws org.openapitools.control.client.ApiException If fails to update the parameters
     */
     ...
     * @throws org.openapitools.control.client.ApiException If fail to serialize the request body object into a string
     */

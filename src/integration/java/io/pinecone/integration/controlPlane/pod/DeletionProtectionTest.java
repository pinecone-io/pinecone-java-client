...
public class DeletionProtectionTest {
    ...
    public void createPodIndexWithDeletionProtectionEnabled() {
        ...
        controlPlaneClient.configureIndex(indexName, "p1.x1", DeletionProtection.DISABLED);
        // Delete index
    ...
    public void createPodIndexWithDeletionProtectionDisabled() {
        ...
        controlPlaneClient.configureIndex(indexName, "p1.x1", DeletionProtection.ENABLED);
